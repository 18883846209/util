...
const json = [
  { id: 2, name: 'test2', child: [{ id: 11, name: 'text11' }, { id: 12, name: 'text12' }] },
  { id: 3, name: 'test3' }
];
...
window.onload = function() {
  ...
  let t = 3545;
  console.log(sectotime(3600), timetosec('01:30:00'));
  setInterval(() => {
    console.log(sectotime(t), timetosec('01:30:00'));
    t -= 1;
  }, 1000);
  json.forEach((item) => {
    if (item.child) {
      console.log(Array.isArray(item.child));
    }
  });
